...
mod tests {
    ...
    fn test_add() {
        ...
        assert_eq!(TotalClaimableMapImpl::get(ref totalClaimableMap, Tick { value: 2147483647 }), 412443);
        ...
        assert_eq!(TotalClaimableMapImpl::get(ref totalClaimableMap, Tick { value: 100 }), 18446744073709551615);
        ...
        assert_eq!(TotalClaimableMapImpl::get(ref totalClaimableMap, Tick { value: -2147483648 }), 412447);
    }
}
